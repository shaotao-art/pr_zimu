...
seajs._util.log = function() {
    if ("undefined" != typeof console) {
        ...
        t = "log";
        if (console[e[e.length - 1]] && (t = e.pop()), "log" !== t || seajs.debug) if (console[t].apply);
        else e.length
    }
},
function(e, t, n) {
    ...
    p = /^(.*?\w)(?:\/|$)/,
    h = {},
    m = (n = n.location).protocol + "//" + n.host +
    function(e) {
    ...
    e.parseMap = function(n) {
        ...
        l = 0; l < a.length; l++) {
            ...
            if (e.isArray(c) && 2 === c.length) {
                var u = c[0]; (e.isString(u) && -1 < o.indexOf(u) || e.isRegExp(u) && u.test(o)) && (o = o.replace(u, c[1]))
            } else e.isFunction(c) && (o = c(o))
        }
        return s(o) || (o = i(r(m) + o)),
        o !== n && (h[o] = n),
        o
    },
    ...
    e.id2Uri = function(e, n) {
        ...
        n || (n = m);
        var i;
        return s(e) ? i = e: 0 === e.indexOf("./") || 0 === e.indexOf("../") ? (0 === e.indexOf("./") && (e = e.substring(2)), i = r(n) + e) : i = l(e) ? n.match(p)[1] + e: t.base + "/" + e,
        a(i)
    },
    e.isAbsolute = s,
    e.isRoot = l,
...
function(e, t) {
    ...
    e.fetch = function(t, i, s) {
        ...
        s && (s = e.isFunction(s) ? s(t) : s) && (f.charset = s),
        i = i || a,
        "SCRIPT" === f.nodeName ? n(f, i) : r(f, i),
        l ? (f.rel = "stylesheet", f.href = t) : (f.async = "async", f.src = t),
        o = f,
        u ? c.insertBefore(f, u) : c.appendChild(f),
        o = null
    },
...
function(e, t, n) {
    ...
    function i(e, n) {
        return t.isString(e) ? r._resolve(e, n) : t.map(e,
        function(e) {
            return i(e, n)
        })
    }
    function a(e, i) {
        var a = t.parseMap(e);
        g[a] ? i() : m[a] ? v[a].push(i) : (m[a] = !0, v[a] = [i], r._fetch(a,
        function() {
            g[a] = !0;
            var n = d[e];
            n.status === h.FETCHING && (n.status = h.FETCHED),
            y && (r._save(e, y), y = null),
            b && n.status === h.FETCHED && (d[e] = b, b.realUri = e),
            b = null,
            m[a] && delete m[a],
            (n = v[a]) && (delete v[a], t.forEach(n,
            function(e) {
                e()
            }))
        },
    ...
    function l(e) {
        var n = e.uri;
        return t.filter(e.dependencies,
        function(e) {
            return x = [n],
            (e = c(d[e])) && (x.push(n), t.log("Found circular dependencies:", x.join(" --\x3e "), void 0)),
            !e
        })
    }
    function c(e) {
    ...
    r.prototype._load = function(e, n) {
        function i(e) { (e || {}).status < h.READY && (e.status = h.READY),
            0 == --c && n()
        }
        var o = t.filter(e,
        function(e) {
    ...
    r.prototype._compile = function() {
        function e(e) {
            return e = i(e, n.uri),
            (e = d[e]) ? e.status === h.COMPILING ? e.exports: (e.parent = n, e._compile()) : null
        }
        var n = this;
        ...
        n.exports = {};
        var r = n.factory;
        return t.isFunction(r) ? (p.push(n), o(r, n), p.pop()) : void 0 !== r && (n.exports = r),
        n.status = h.COMPILED,
        s(n),
        n.exports
    },
    r._define = function(e, n, a) {
        1 === (s = arguments.length) ? (a = e, e = void 0) : 2 === s && (a = n, n = void 0, t.isArray(e) && (n = e, e = void 0)),
        !t.isArray(n) && t.isFunction(a) && (n = t.parseDependencies(a.toString()));
        var o, s = {
            id: e,
            dependencies: n,
            factory: a
        ...
        if (document.attachEvent) {
            ...
            l && (o = t.unParseMap(t.getScriptAbsoluteSrc(l))),
            o || t.log("Failed to derive URI from interactive script for:", a.toString(), "warn")
        }
        if (l = e ? i(e) : o) {
            if (l === o) {
                var c = d[o];
            ...
            s = r._save(l, s),
            o ? (d[o] || {}).status === h.FETCHING && (d[o] = s, s.realUri = o) : b || (b = s)
        } else y = s
    },
    ...
    r._find = function(e) {
        var n = [];
        return t.forEach(t.keys(d),
        function(r) { (t.isString(e) && -1 < r.indexOf(e) || t.isRegExp(e) && e.test(r)) && (r = d[r]).exports && n.push(r.exports)
        }),
        n
    },
    r._modify = function(t, n) {
        var r = i(t),
        a = d[r];
        return a && a.status === h.COMPILED ? o(n, a) : (f[r] || (f[r] = []), f[r].push(n)),
        e
    },
    r.STATUS = h,
    r._resolve = t.id2Uri,
    ...
    r._save = function(e, n) {
        ...
        return a.status < h.SAVED && (a.id = n.id || e, a.dependencies = i(t.filter(n.dependencies || [],
        function(e) {
            return !! e
        }), e), a.factory = n.factory, a.status = h.SAVED),
        a
    };
    var m = {},
    g = {},
...
function(e, t, n) {
    ...
    var a = i && t.getScriptAbsoluteSrc(i) || t.pageUri,
    a = t.dirname(function(e) {
        if ( - 1 === e.indexOf("??")) return e;
        var n = e.split("??");
        return (e = n[0]) + (n = t.filter(n[1].split(","),
        function(e) {
    ...
    e.config = function(i) {
        for (var a in i) if (i.hasOwnProperty(a)) {
            ...
            } else ! o || "map" !== a && "preload" !== a ? n[a] = s: (t.isString(s) && (s = [s]), t.forEach(s,
            function(e) {
                e && o.push(e)
            }))
        }
        return (i = n.base) && !t.isAbsolute(i) && (n.base = t.id2Uri((t.isRoot(i) ? "": "./") + i + "/")),
        2 === n.debug && (n.debug = 1, e.config({
            map: [[/^.*$/,
            function(e) {
...
function(e, t, n) {
    ...
    t.forEach(function() {
        var e = [],
        r = n.location.search;
        return (r = (r = r.replace(/(seajs-\w+)(&|$)/g, "$1=1$2")) + " " + document.cookie).replace(/seajs-(\w+)=[1-9]/g,
        function(t, n) {
            e.push(n)
        }),
        t.unique(e)
    ...
    function(t) {
        ...
        "debug" === t && (e._use = e.use, e._useArgs = [], e.use = function() {
...
define("newweb/common/TranslateState", [],
function(e, t) {
    e("./jquery-1.7");
    var n = {
        smallFont: !1,
...
define("newweb/common/ZeroClipboard", [],
function(e, t) { !
    function(e, t) {
        "use strict";
        var n, r, i, a = e,
        ...
        b = a.Date.now,
        x = a.Object.keys,
        w = a.Object.prototype.hasOwnProperty,
        ...
        S = function(e) {
            ...
            else if ("number" == typeof e.length) for (t = [], n = 0, r = e.length; n < r; n++) w.call(e, n) && (t[n] = S(e[n]));
            else {
                t = {};
        ...
        E = function(e, t) {
            for (var n = {},
            r = 0,
            i = t.length; r < i; r++) t[r] in e && (n[t[r]] = e[t[r]]);
            return n
        },
        j = function(e, t) {
            var n = {};
        ...
        I = "html" === o.documentElement.nodeName,
        H = {
            bridge: null,
            version: "0.0.0",
            pluginType: "unknown",
        ...
        Z = new RegExp("^flash-(" + V.filter(function(e) {
        ...
        G = function(e) {
            "object" != typeof e || !e || "length" in e || x(e).forEach(function(t) {
                ...
                else if (null == H.bridge) if ("containerId" === t || "swfObjectId" === t) {
        ...
        J = function() {
            return Ye(),
            {
                browser: C(E(s, ["userAgent", "platform", "appName", "appVersion"]), {
                    isSupported: Q()
                }),
                flash: j(H, ["bridge"]),
                zeroclipboard: {
        ...
        te = function(e, t) {
            ...
            if ("string" == typeof e && e ? a = e.toLowerCase().split(/\s+/) : "object" != typeof e || !e || "length" in e || void 0 !== t || x(e).forEach(function(t) {
                ...
                for (r = 0, i = a.length; r < i; r++) o[e = a[r].replace(/^on/, "")] = !0,
                z[e] || (z[e] = []),
                z[e].push(t);
                if (o.ready && H.ready && Ke.emit({
                    type: "ready"
                }), o.error) {
                    for (Q() || Ke.emit({
                        type: "error",
        ...
        ne = function(e, t) {
            ...
            }), a && a.length) for (n = 0, r = a.length; n < r; n++) if (e = a[n].replace(/^on/, ""), (o = z[e]) && o.length) if (t) for (i = o.indexOf(t); - 1 !== i;) o.splice(i, 1),
            i = o.indexOf(t, i);
            else o.length = 0;
            return Ke
        },
        ...
        ie = function(e) {
            ...
            e), xe.call(this, t), "copy" === e.type && (n = (r = De(P)).data, B = r.formatMap), n)
        },
        ae = function() {
            var e = K.swfPath || "",
            t = e.slice(0, 2),
        ...
        oe = function() {
            ...
            H.sandboxed !== n && !0 === H.sandboxed ? (H.ready = !1, Ke.emit({
                type: "error",
        ...
        le = function(e, t) {
            var n;
            if ("object" == typeof e && e && void 0 === t) n = e,
            Ke.clearData();
            else {
                if ("string" != typeof e || !e) return; (n = {})[e] = t
            }
        ...
        de = function(e) {
            if (e && 1 === e.nodeType) {
                r && (He(r, K.activeClass), r !== e && He(r, K.hoverClass)),
                r = e,
                Ie(e, K.hoverClass);
        ...
        fe = function() {
            var e = Ee(H.bridge);
            e && (e.removeAttribute("title"), e.style.left = "0px", e.style.top = "-9999px", e.style.width = "1px", e.style.height = "1px"),
            r && (He(r, K.hoverClass), He(r, K.activeClass), r = null)
        },
        pe = function() {
            return r || null
        },
        ...
        xe = function(e) {
            if ("object" == typeof e && e && e.type) {
                ...
                if (i && i.length) {
                    ...
                    for (o = 0, s = i.length; o < s; o++) c = d,
                    "string" == typeof(l = i[o]) && "function" == typeof a[l] && (l = a[l]),
                    "object" == typeof l && l && "function" == typeof l.handleEvent && (c = l, l = l.handleEvent),
                    "function" == typeof l && (u = C({},
                    e), be(l, c, [u], t))
                }
                return this
            }
        ...
        we = function(e) {
            var t = null;
            return (!1 === R || e && "error" === e.type && e.name && -1 !== X.indexOf(e.name)) && (t = !1),
            t
        },
        Te = function(e) {
            ...
            case "error":
                ...
                "boolean" == typeof o && (H.sandboxed = o),
                "browser-unsupported" === e.name ? C(H, {
                    disabled: !1,
                    outdated: !1,
                    unavailable: !1,
                    degraded: !1,
            ...
            case "beforecopy":
                ...
                break;
            case "copy":
                var l, c, u = e.relatedTarget; ! P["text/html"] && !P["text/plain"] && u && (c = u.value || u.outerHTML || u.innerHTML) && (l = u.value || u.textContent || u.innerText) ? (e.clipboardData.clearData(), e.clipboardData.setData("text/plain", l), c !== l && e.clipboardData.setData("text/html", c)) : !P["text/plain"] && e.target && (l = e.target.getAttribute("data-clipboard-text")) && (e.clipboardData.clearData(), e.clipboardData.setData("text/plain", l));
                break;
            case "aftercopy":
                _e(e),
                Ke.clearData(),
                t && t !== Re() && t.focus && t.focus();
                break;
            case "_mouseover":
                Ke.focus(t),
                !0 === K.bubbleEvents && a && (t && t !== e.relatedTarget && !A(e.relatedTarget, t) && ke(C({},
                e, {
                    type: "mouseenter",
                    bubbles: !1,
                    cancelable: !1
        ...
        Ce = function() {
            ...
            if ("number" == typeof e && e >= 0) {
                ...
                W = u(function() {
                    ...
                    Be(e) && (Ue(), H.deactivated = null, Ke.emit({
                        type: "error",
                        name: "swf-not-found"
                    }))
                },
        ...
        Ne = function() {
            ...
            return t || ((t = o[K.swfObjectId]) && (e = t.length) && (t = t[e - 1]), !t && n && (t = n.firstChild)),
            H.bridge = t || null,
            t
        },
        Ae = function() {
            ...
            if (e) {
                var t = Ee(e);
                t && ("activex" === H.pluginType && "readyState" in e ? (e.style.display = "none",
                function n() {
                    if (4 === e.readyState) {
        ...
        Oe = function(e, t) {
            ...
            for (var r in e) if (w.call(e, r)) if ("errors" === r) {
                n[r] = e[r] ? e[r].slice() : [];
                for (var i = 0,
                a = n[r].length; i < a; i++) n[r][i].format = t[n[r][i].format]
        ...
        Fe = function(e) {
            ...
            return s.length && (o += "trustedOrigins=" + p(s.join(","))),
            !0 === e.forceEnhancedClipboard && (o += (o ? "&": "") + "forceEnhancedClipboard=true"),
        ...
        Ie = function(e, t) {
            ...
            if ("string" == typeof t && t && (a = t.split(/\s+/)), e && 1 === e.nodeType && a.length > 0) {
                for (i = (" " + (e.className || "") + " ").replace(/[\t\r\n\f]/g, " "), n = 0, r = a.length; n < r; n++) - 1 === i.indexOf(" " + a[n] + " ") && (i += a[n] + " "); (i = i.replace(/^\s+|\s+$/g, "")) !== e.className && (e.className = i)
            }
            return e
        },
        He = function(e, t) {
            ...
            if ("string" == typeof t && t && (a = t.split(/\s+/)), e && 1 === e.nodeType && a.length > 0 && e.className) {
                for (i = (" " + e.className + " ").replace(/[\t\r\n\f]/g, " "), n = 0, r = a.length; n < r; n++) i = i.replace(" " + a[n] + " ", " "); (i = i.replace(/^\s+|\s+$/g, "")) !== e.className && (e.className = i)
            }
            return e
        },
        ze = function(e, t) {
        ...
        Pe = function(e) {
            ...
            if (e.getBoundingClientRect) {
                ...
                if ("relative" === ze(o.body, "position")) {
                    ...
                    f = o.documentElement.getBoundingClientRect();
                    c = d.left - f.left || 0,
                    u = d.top - f.top || 0
                }
                t.left = n.left + r - s - c,
        ...
        Ze = function(e) {
            ...
            c = !1,
            u = "";
            if (s.plugins && s.plugins.length) r(s.plugins["Shockwave Flash"]),
            s.plugins["Shockwave Flash 2.0"] && (o = !0, u = "2.0.0.11");
            else if (s.mimeTypes && s.mimeTypes.length) r((a = s.mimeTypes["application/x-shockwave-flash"]) && a.enabledPlugin);
            else if (void 0 !== e) {
                l = !0;
                try {
            ...
            H.disabled = !0 !== o,
            H.outdated = u && v(u) < v("11.0.0"),
            H.version = u || "0.0.0",
            H.pluginType = c ? "pepper": l ? "activex": o ? "netscape": "unknown"
        };
        Ze(h),
        Ye(!0);
        var Ke = function() {
        ...
        it = function(e, t) {
            ...
            }), a && a.length) for (n = 0, r = a.length; n < r; n++) if (e = a[n].toLowerCase().replace(/^on/, ""), (o = c[e]) && o.length) if (t) for (i = o.indexOf(t); - 1 !== i;) o.splice(i, 1),
            i = o.indexOf(t, i);
            else o.length = 0;
            return s
        },
        at = function(e) {
            ...
            return n && (t = "string" == typeof e && e ? n[e] ? n[e].slice(0) : [] : S(n)),
            t
        },
        ot = function(e) {
            var t, n = this;
            return dt.call(n, e) && ("object" == typeof e && e && "string" == typeof e.type && e.type && (e = C({},
            e)), t = C({},
            me(e), {
                client: n
            }), ft.call(n, t)),
        ...
        st = function(e) {
            ...
            for (var t = 0; t < e.length; t++) if (w.call(e, t) && e[t] && 1 === e[t].nodeType) {
                ...
                var n = Je[this.id] && Je[this.id].elements; - 1 === n.indexOf(e[t]) && n.push(e[t])
            }
            return this
        },
        lt = function(e) {
            var t = Je[this.id];
            if (!t) return this;
            for (var n, r = t.elements,
            i = (e = void 0 === e ? r.slice(0) : pt(e)).length; i--;) if (w.call(e, i) && e[i] && 1 === e[i].nodeType) {
        ...
        ft = function(e) {
            ...
            if ("object" == typeof e && e && e.type && t) {
                ...
                if (o && o.length) {
                    ...
                    for (s = 0, l = o.length; s < l; s++) u = f,
                    "string" == typeof(c = o[s]) && "function" == typeof a[c] && (c = a[c]),
                    "object" == typeof c && c && "function" == typeof c.handleEvent && (u = c, c = c.handleEvent),
        ...
        ht = function(e) {
            if (e && 1 === e.nodeType) {
                var t = function(e) { (e || (e = a.event)) && ("js" !== e._source && (e.stopImmediatePropagation(), e.preventDefault()), delete e._source)
                },
                n = function(n) { (n || (n = a.event)) && (t(n), Ke.focus(e))
                };
        ...
        Ke.prototype.setData = function() {
            if (!Je[this.id]) throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
            return Ke.setData.apply(this, k(arguments)),
            this
        },
        Ke.prototype.clearData = function() {
            ...
            return Ke.clearData.apply(this, k(arguments)),
            this
        },
...
define("newweb/common/account", ["./log"],
function(e, t) {
    function n(e, t) {
        if ("js" === t) {
    ...
    function i() {
        o("#urs-login-block").remove(),
        o("#loginWindow .content").append("<div id='urs-login-block' style='width:400px;'></div>")
    }
    function a() {
        f.on("click",
        function() {
    ...
    c = o("#loginWindow"),
    u = o(".third-login-qq"),
    d = o(".third-login-weixin"),
    f = o(".third-login-weibo"),
    p = e("./log"),
    h = (new Date).getTime(),
    ...
    t.init = function() {
        if (s.find(".dialog-alert--close").on("click",
        function() {
            r()
        }), s.find(".cancel, .ok").on("click",
        function() {
            r()
        }), n(m, "js"), n(g, "js"), n(v, "css"), o(".login-link").on("click",
        function() {
            i(),
            a(),
            p.clog("LOGIN_CLICK", ""),
            ...
            y.regcb = function(e) {}
        }), c.find(".dialog-alert--close").on("click",
        function() {
            l.hide(),
            c.hide()
...
define("newweb/common/advertisement", ["./utils"],
function(e, t) {
    var n = e("./jquery-1.7"),
    r = e("./utils");
    n(function() {
        ...
        function(e) {
            if (e.data) {
                ...
                t.height && (i.height = t.height),
                t.width && (i.width = t.width)
            }
        },
        !1),
        t(),
        r.addEvent("resize", window, r.throttle(100, t))
    })
}),
function(e) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
    else if ("function" == typeof define && define.amd) define("newweb/common/clipboard.min", [], e);
    else { ("undefined" != typeof window ? window: "undefined" != typeof global ? global: "undefined" != typeof self ? self: this).Clipboard = e()
    }
} (function() {
        ...
        6 : [function(e, t, n) {
            ...
            r.prototype = {
                ...
                off: function(e, t) {
                    ...
                    i = [];
                    if (r && t) for (var a = 0,
                    o = r.length; a < o; a++) r[a].fn !== t && r[a].fn._ !== t && i.push(r[a]);
        ...
        8 : [function(e, t, n) { !
            function(r, i) {
                if (void 0 !== n) i(t, e("./clipboard-action"), e("tiny-emitter"), e("good-listener"));
                    ...
                    i(a, r.clipboardAction, r.tinyEmitter, r.goodListener),
...
define("newweb/common/constData", [],
function(e, t) {
    t.errorMsg = {
        10 : "抱歉，个别句子太长啦，我读不懂",
...
define("newweb/common/copy", ["./ZeroClipboard", "./log", "./utils"],
function(e, t) {
    var n = e("./jquery-1.7");
    e("./ZeroClipboard");
    var r = e("./log");
...
function(e, t) {
    ...
    function a(e, t) {
        ...
        e ? (_.find(".doc-type").addClass("doc-type-error"), p(".doc-error-msg").text(i).show(), p(".doc-size-msg").text(r).hide()) : (_.find(".doc-type").removeClass("doc-type-error"), p(".doc-error-msg").text(i).hide(), p(".doc-size-msg").text(r).show()),
        d(),
        _.show()
    }
    function o() {
    ...
    function l(e) {
        ...
        setTimeout(function() {
            if (0 == e.errorcode && e.key) {
                var t = n(),
                r = A; - 1 != location.search.indexOf("type=pdf") && (r = resultUrlPdf),
                p("#language").val("AUTO"),
                window.location.href = [r, "?key=" + e.key, "&from=" + t.from, "&to=" + t.to, "&type=" + t.type, "&src=new-fanyiweb"].join("")
    ...
    t.uploadFile = function() {
        ...
        S = T.ajaxForm({
            ...
            error: function(e, t) {
                ...
                u(),
                N ? N = !0 : (alert("上传失败，请重试。"), window.location.reload())
            }
        }),
        c(),
        T.submit()
...
define("newweb/common/download", ["./utils", "./log"],
function(e, t) {
    function n() {
        a.on("click",
        function() {
    ...
    p = function() {
        d(function(e) {
            ...
            a = e.link || "javascript:;",
            o = e.mimeSrc;
            t == n && 1 == r || (i.cookie("fanyi-ad-id", t), i.cookie("fanyi-ad-closed", 0), s.attr("href", a), "" == e.link && s.css({
                cursor: "default"
            }), l.attr("src", o), f())
        })
    };
...
function(e) { !
    function(t) {
        ...
        function n(t) {
            ...
            var a = n.form;
            if (a.clk = n, "image" === n.type) if (void 0 !== t.offsetX) a.clk_x = t.offsetX,
            a.clk_y = t.offsetY;
            else if ("function" == typeof e.fn.offset) {
                var o = r.offset();
                a.clk_x = t.pageX - o.left,
                a.clk_y = t.pageY - o.top
            } else a.clk_x = t.pageX - n.offsetLeft,
            a.clk_y = t.pageY - n.offsetTop;
            setTimeout(function() {
        ...
        e.fn.ajaxSubmit = function(t, n, i, s) {
            function l(n) {
                ...
                o = a.length,
                s = [];
                for (r = 0; r < o; r++) a[r] = a[r].replace(/\+/g, " "),
                i = a[r].split("="),
            ...
            function c(n) {
                ...
                function a() {
                    ...
                    a !== d.url && _.setAttribute("action", d.url),
                    d.skipEncodingOverride || u && !/post/i.test(u) || p.attr({
                    ...
                    try {
                        ...
                        _.setAttribute("action", a),
                        _.setAttribute("enctype", o),
                ...
                function s(t) {
                    if (!y.aborted && !L) {
                        if ((O = i(g)) || (r("cannot access response document"), t = j), t === E && y) return y.abort("timeout"),
                        void k.reject(y, "timeout");
                        if (t === j && y) return y.abort("server abort"),
                        ...
                        if (O && O.location.href !== d.iframeSrc || w) {
                            ...
                            try {
                                ...
                                if (r("isXml=" + o), !o && window.opera && (null === O.body || !O.body.innerHTML) && --F) return r("requeing onLoad callback, DOM not available"),
                            ...
                            "success" === a ? (d.success && d.success.call(d.context, D, "success", y), k.resolve(y.responseText, "success", y), f && e.event.trigger("ajaxSuccess", [y, d])) : a && (void 0 === n && (n = y.statusText), d.error && d.error.call(d.context, y, a, n), k.reject(y, "error", n), f && e.event.trigger("ajaxError", [y, d, n])),
                            f && e.event.trigger("ajaxComplete", [y, d]),
                            f && !--e.active && e.event.trigger("ajaxStop"),
                            d.complete && d.complete.call(d.context, y, a),
                            L = !0,
                            d.timeout && clearTimeout(T),
                            setTimeout(function() {
                                d.iframeTarget ? m.attr("src", d.iframeSrc) : m.remove(),
                                y.responseXML = null
                            },
                            100)
                        }
                ...
                n) for (c = 0; c < v.length; c++) l = e(v[c]),
                o ? l.prop("disabled", !1) : l.removeAttr("disabled"); (d = e.extend(!0, {},
                e.ajaxSettings, t)).context = d.context || d,
                ...
                if (d.iframeTarget ? (x = (m = e(d.iframeTarget, C)).attr2("name")) ? h = x: m.attr2("name", h) : (m = e('<iframe name="' + h + '" src="' + d.iframeSrc + '" />', C)).css({
                    ...
                    abort: function(t) {
                        ...
                        m.attr("src", d.iframeSrc),
                        y.error = n,
                        d.error && d.error.call(d.context, y, n, t),
                        f && e.event.trigger("ajaxError", [y, d, n]),
                        d.complete && d.complete.call(d.context, y, n)
                    }
                },
                (f = d.global) && 0 == e.active++&&e.event.trigger("ajaxStart"), f && e.event.trigger("ajaxSend", [y, d]), d.beforeSend && !1 === d.beforeSend.call(d.context, y, d)) return d.global && e.active--,
                k.reject(),
                k;
                if (y.aborted) return k.reject(),
                k; (b = _.clk) && (x = b.name) && !b.disabled && (d.extraData = d.extraData || {},
                d.extraData[x] = b.value, "image" === b.type && (d.extraData[x + ".x"] = _.clk_x, d.extraData[x + ".y"] = _.clk_y));
                var E = 1,
                j = 2,
                N = e("meta[name=csrf-token]").attr("content"),
                A = e("meta[name=csrf-param]").attr("content");
                A && N && (d.extraData = d.extraData || {},
                d.extraData[A] = N),
                d.forceSync ? a() : setTimeout(a, 10);
                var D, O, L, F = 50,
                q = e.parseXML ||
                function(e, t) {
                    return window.ActiveXObject ? ((t = new ActiveXObject("Microsoft.XMLDOM")).async = "false", t.loadXML(e)) : t = (new DOMParser).parseFromString(e, "text/xml"),
                ...
                R = function(t, n, r) {
                    ...
                    "string" == typeof o && (("json" === n || !n) && i.indexOf("json") >= 0 ? o = M(o) : ("script" === n || !n) && i.indexOf("javascript") >= 0 && e.globalEval(o)),
                    o
                };
                return k
            }
            if (!this.length) return r("ajaxSubmit: skipping submit process - no element selected"),
            this;
            var u, d, f, p = this;
            "function" == typeof t ? t = {
                success: t
            ...
            (f = (f = "string" == typeof(d = t.url || this.attr2("action")) ? e.trim(d) : "") || window.location.href || "") && (f = (f.match(/^([^#]+)/) || [])[1]),
            t = e.extend(!0, {
                url: f,
            ...
            t);
            var h = {};
            if (this.trigger("form-pre-serialize", [this, t, h]), h.veto) return r("ajaxSubmit: submit vetoed via form-pre-serialize trigger"),
            this;
            if (t.beforeSerialize && !1 === t.beforeSerialize(this, t)) return r("ajaxSubmit: submit aborted via beforeSerialize callback"),
            this;
            var m = t.traditional;
            ...
            if (t.beforeSubmit && !1 === t.beforeSubmit(y, this, t)) return r("ajaxSubmit: submit aborted via beforeSubmit callback"),
            this;
            if (this.trigger("form-submit-validate", [y, this, t, h]), h.veto) return r("ajaxSubmit: submit vetoed via form-submit-validate trigger"),
            this;
            var x = e.param(y, m);
            g && (x = x ? x + "&" + g: g),
            "GET" === t.type.toUpperCase() ? (t.url += (t.url.indexOf("?") >= 0 ? "&": "?") + x, t.data = null) : t.data = x;
            var w = [];
            ...
            if (t.success = function(e, n, r) {
                for (var i = t.context || this,
                a = 0,
                o = w.length; a < o; a++) w[a].apply(i, [e, n, r || p, p])
            },
            t.error) {
                var _ = t.error;
            ...
            r("fileAPI :" + j);
            var N, A = (C || E) && !j; ! 1 !== t.iframe && (t.iframe || A) ? t.closeKeepAlive ? e.get(t.closeKeepAlive,
            function() {
                N = c(y)
            }) : N = c(y) : N = (C || E) && j ?
            function(n) {
                for (var r = new FormData,
                i = 0; i < n.length; i++) r.append(n[i].name, n[i].value);
                if (t.extraData) {
                    var a = l(t.extraData);
        ...
        e.fn.ajaxForm = function(i, a, o, s) {
            ...
            "function" == typeof s && (i.success = s)), i = i || {},
        ...
        e.fn.formToArray = function(t, n, r) {
            ...
            if (!t && s.clk) {
                var y = e(s.clk),
                b = y[0]; (f = b.name) && !b.disabled && "image" === b.type && (i.push({
                    name: f,
                    value: y.val()
                }), i.push({
                    name: f + ".x",
        ...
        e.fn.fieldSerialize = function(t) {
            ...
            return this.each(function() {
                ...
                if (r) {
                    ...
                    if (i && i.constructor === Array) for (var a = 0,
                    o = i.length; a < o; a++) n.push({
                        name: r,
                        value: i[a]
                    });
            ...
            return this.each(function() {
                ...
                case "select":
                    return t.find("option").each(function(e) {
                        if (this.selected = this.defaultSelected, this.defaultSelected && !t[0].multiple) return t[0].selectedIndex = e,
                        !1
                    }),
                    !0;
                case "label":
...
define("newweb/common/hotLink", ["./log"],
function(e, t) {
    var n = e("./jquery-1.7"),
...
define("newweb/common/jquery-1.7", [],
function(e, t) {
    return function(e, t) {
        function n(e) {
            var t, n, r = M[e] = {};
        ...
        function a(e, t, n) {
            ...
            i = t + "queue",
            a = t + "mark",
            o = q._data(e, r); ! o || "queue" !== n && q._data(e, i) || "mark" !== n && q._data(e, a) || setTimeout(function() {
        ...
        function v(e, t) {
            t.src ? q.ajax({
                ...
                async: !1,
                dataType: "script"
            }) : q.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Ce, "/*$0*/")),
            t.parentNode && t.parentNode.removeChild(t)
        }
        function y(e, t, n) {
            var r = "width" === t ? e.offsetWidth: e.offsetHeight,
            i = "width" === t ? Ie: He;
            return r > 0 ? ("border" !== n && q.each(i,
            function() {
                n || (r -= parseFloat(q.css(e, "padding" + this)) || 0),
                "margin" === n ? r += parseFloat(q.css(e, n + this)) || 0 : r -= parseFloat(q.css(e, "border" + this + "Width")) || 0
            }), r + "px") : (((r = je(e, t, t)) < 0 || null == r) && (r = e.style[t] || 0), r = parseFloat(r) || 0, n && q.each(i,
            function() {
                r += parseFloat(q.css(e, "padding" + this)) || 0,
                "padding" !== n && (r += parseFloat(q.css(e, "border" + this + "Width")) || 0),
                "margin" === n && (r += parseFloat(q.css(e, n + this)) || 0)
            }), r + "px")
        }
        function b(e) {
            return function(t, n) {
                if ("string" != typeof t && (n = t, t = "*"), q.isFunction(n)) for (var r, i, a = t.toLowerCase().split(et), o = 0, s = a.length; o < s; o++) r = a[o],
        ...
        function T(e, t, n, r) {
            ...
            else for (var i in t) T(e + "[" + i + "]", t[i], n, r)
        }
        function _(e, n, r) {
        ...
        function k(e, n) {
            ...
            var r, i, a, o, s, l, c, u, d = e.dataTypes,
            f = {},
            p = d.length,
            h = d[0];
            for (r = 1; r < p; r++) {
                ...
                if (o = h, "*" === (h = d[r])) h = o;
                    ...
                    if (s = o + " " + h, !(l = f[s] || f["* " + h])) {
                        u = t;
                        for (c in f) if (((a = c.split(" "))[0] === o || "*" === a[0]) && (u = f[a[1] + " " + h])) { ! 0 === (c = f[c]) ? l = u: !0 === u && (l = c);
                            break
                        }
                    }
                    l || u || q.error("No conversion from " + s.replace(" ", " to ")),
                    !0 !== l && (n = l ? l(n) : u(c(n)))
                }
            }
            return n
        ...
        function N(e, t) {
            var n = {};
            return q.each(bt.concat.apply([], bt.slice(0, t)),
            function() {
                n[this] = e
            }),
            n
        ...
        function A(e) {
            if (!gt[e]) {
                ...
                r = n.css("display");
                n.remove(),
                "none" !== r && "" !== r || (ft || ((ft = O.createElement("iframe")).frameBorder = ft.width = ft.height = 0), t.appendChild(ft), pt && ft.createElement || ((pt = (ft.contentWindow || ft.contentDocument).document).write(("CSS1Compat" === O.compatMode ? "<!doctype html>": "") + "<html><body>"), pt.close()), n = pt.createElement(e), pt.body.appendChild(n), r = q.css(n, "display"), t.removeChild(ft)),
                gt[e] = r
            }
            return gt[e]
        }
        ...
        q = function() {
            ...
            return s.fn = s.prototype = {
                ...
                init: function(e, n, r) {
                    ...
                    if ("string" == typeof e) {
                        ...
                        (o = m.exec(e)) ? s.isPlainObject(n) ? (e = [O.createElement(o[1])], s.fn.attr.call(e, n, !0)) : e = [l.createElement(o[1])] : e = ((o = s.buildFragment([i[1]], [l])).cacheable ? s.clone(o.fragment) : o.fragment).childNodes,
                        s.merge(this, e);
            ...
            s.extend = s.fn.extend = function() {
                ...
                u = arguments.length,
                d = !1;
                for ("boolean" == typeof l && (d = l, l = arguments[1] || {},
                c = 2), "object" == typeof l || s.isFunction(l) || (l = {}), u === c && (l = this, --c); c < u; c++) if (null != (e = arguments[c])) for (n in e) r = l[n],
                l !== (i = e[n]) && (d && i && (s.isPlainObject(i) || (a = s.isArray(i))) ? (a ? (a = !1, o = r && s.isArray(r) ? r: []) : o = r && s.isPlainObject(r) ? r: {},
                l[n] = s.extend(d, o, i)) : i !== t && (l[n] = i));
                return l
            },
            s.extend({
                ...
                merge: function(e, n) {
                    var r = e.length,
                    i = 0;
                    if ("number" == typeof n.length) for (var a = n.length; i < a; i++) e[r++] = n[i];
                ...
                grep: function(e, t, n) {
                    ...
                    n = !!n;
                    for (var i = 0,
                    a = e.length; i < a; i++) n !== !!t(e[i], i) && r.push(e[i]);
                    return r
                },
                map: function(e, n, r) {
                    var i, a, o = [],
                    l = 0,
                    c = e.length;
                    if (e instanceof s || c !== t && "number" == typeof c && (c > 0 && e[0] && e[c - 1] || 0 === c || s.isArray(e))) for (; l < c; l++) null != (i = n(e[l], l, r)) && (o[o.length] = i);
                    else for (a in e) null != (i = n(e[a], a, r)) && (o[o.length] = i);
            ...
            (i = s.uaMatch(E)).browser && (s.browser[i.browser] = !0, s.browser.version = i.version),
        ...
        q.Callbacks = function(e) {
            ...
            u = function(t) {
                ...
                "array" === (a = q.type(i)) ? u(i) : "function" === a && (e.unique && f.has(i) || l.push(i))
            },
            d = function(t, n) {
                ...
                i = !1,
                l && (e.once ? !0 === r ? f.disable() : l = [] : c && c.length && (r = c.shift(), f.fireWith(r[0], r[1])))
            },
            f = {
                add: function() {
                    if (l) {
                        var e = l.length;
                        u(arguments),
                        i ? o = l.length: r && !0 !== r && (a = e, d(r[0], r[1]))
                    }
                    return this
                },
                remove: function() {
                    ...
                    n = 0,
                    r = t.length; n < r; n++) for (var a = 0; a < l.length && (t[n] !== l[a] || (i && a <= o && (o--, a <= s && s--), l.splice(a--, 1), !e.unique)); a++);
                    return this
                },
                has: function(e) {
                    if (l) for (var t = 0,
                    n = l.length; t < n; t++) if (e === l[t]) return ! 0;
                    return ! 1
                },
                empty: function() {
                    return l = [],
                ...
                fireWith: function(t, n) {
                    return c && (i ? e.once || c.push([t, n]) : e.once && r || d(t, n)),
                    this
                },
                fire: function() {
        ...
        q.extend({
            Deferred: function(e) {
                var t, n = q.Callbacks("once memory"),
                r = q.Callbacks("once memory"),
                i = q.Callbacks("memory"),
                a = "pending",
                o = {
                    resolve: n,
                    reject: r,
                    ...
                    pipe: function(e, t, n) {
                        return q.Deferred(function(r) {
                            ...
                            function(e, t) {
                                var n, i = t[0],
                                a = t[1];
                                q.isFunction(i) ? l[e](function() { (n = i.apply(this, arguments)) && q.isFunction(n.promise) ? n.promise().then(r.resolve, r.reject, r.notify) : r[a + "With"](this === l ? r: this, [n])
                                }) : l[e](r[a])
                            })
                        }).promise()
                    },
            ...
            when: function(e) {
                ...
                i = new Array(r),
                a = r,
                o = r <= 1 && e && q.isFunction(e.promise) ? e: q.Deferred(),
                s = o.promise();
                if (r > 1) {
                    for (; n < r; n++) t[n] && t[n].promise && q.isFunction(t[n].promise) ? t[n].promise().then(function(e) {
                        return function(n) {
                            t[e] = arguments.length > 1 ? R.call(arguments, 0) : n,
                            --a || o.resolveWith(o, t)
                        }
                    } (n), o.reject,
                    function(e) {
                        return function(t) {
                            i[e] = arguments.length > 1 ? R.call(arguments, 0) : t,
                            o.notifyWith(s, i)
                        }
                    } (n)) : --a;
                    a || o.resolveWith(o, t)
        ...
        q.support = function() {
            var e, t, n, r, i, a, o, s, l, c, u, d, f, p, h, m, g = O.createElement("div"),
            v = O.documentElement;
            ...
            u && (u.innerHTML = "", c.removeChild(u)),
            u = s = n = r = l = a = g = i = null,
            o
        } (),
        ...
        q.extend({
            ...
            data: function(e, n, r, i) {
                if (q.acceptData(e)) {
                    q.expando;
                    var a, o, s, l = "string" == typeof n,
                    c = e.nodeType,
                    u = c ? q.cache: e,
                    d = c ? e[q.expando] : e[q.expando] && q.expando,
                    f = "events" === n;
                    if (d && u[d] && (f || i || u[d].data) || !l || r !== t) return d || (c ? e[q.expando] = d = ++q.uuid: d = q.expando),
                    u[d] || (u[d] = {},
                    c || (u[d].toJSON = q.noop)),
                    "object" != typeof n && "function" != typeof n || (i ? u[d] = q.extend(u[d], n) : u[d].data = q.extend(u[d].data, n)),
                    a = o = u[d],
                    i || (o.data || (o.data = {}), o = o.data),
                    r !== t && (o[q.camelCase(n)] = r),
                    f && !o[n] ? a.events: (l ? null == (s = o[n]) && (s = o[q.camelCase(n)]) : s = o, s)
                }
            },
            ...
            data: function(e, n) {
                ...
                if (void 0 === e) {
                    if (this.length && (s = q.data(this[0]), 1 === this[0].nodeType && !q._data(this[0], "parsedAttrs"))) {
                        for (var l = 0,
                        c = (a = this[0].attributes).length; l < c; l++) 0 === (o = a[l].name).indexOf("data-") && (o = q.camelCase(o.substring(5)), r(this[0], o, s[o]));
        ...
        q.extend({
            ...
            queue: function(e, t, n) {
                ...
                r = q._data(e, t),
                n && (!r || q.isArray(n) ? r = q._data(e, t, q.makeArray(n)) : r.push(n)),
                r || []
            },
            dequeue: function(e, t) {
                ...
                r && ("fx" === t && n.unshift("inprogress"), q._data(e, t + ".run", i), r.call(e,
                function() {
                    q.dequeue(e, t)
                },
                i)),
                n.length || (q.removeData(e, t + "queue " + t + ".run", !0), a(e, t, "queue"))
            }
        }),
        q.fn.extend({
            queue: function(e, n) {
                return "string" != typeof e && (n = e, e = "fx"),
                n === t ? q.queue(this[0], e) : this.each(function() {
            ...
            promise: function(e, n) {
                function r() {--l || a.resolveWith(o, [o])
                }
        ...
        q.fn.extend({
            ...
            toggleClass: function(e, t) {
                ...
                return q.isFunction(e) ? this.each(function(n) {
                    ...
                    if ("string" === n) for (var i, a = 0,
                    o = q(this), s = t, l = e.split(W); i = l[a++];) o[(s = r ? s: !o.hasClass(i)) ? "addClass": "removeClass"](i);
                    else "undefined" !== n && "boolean" !== n || (this.className && q._data(this, "__className__", this.className), this.className = this.className || !1 === e ? "": q._data(this, "__className__") || "")
                })
            },
            hasClass: function(e) {
                for (var t = " " + e + " ",
                n = 0,
                r = this.length; n < r; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(U, " ").indexOf(t) > -1) return ! 0;
                return ! 1
            },
            val: function(e) {
                var n, r, i, a = this[0];
                return arguments.length ? (i = q.isFunction(e), this.each(function(r) {
                    var a, o = q(this);
                    1 === this.nodeType && (null == (a = i ? e.call(this, r, o.val()) : e) ? a = "": "number" == typeof a ? a += "": q.isArray(a) && (a = q.map(a,
                    function(e) {
                        return null == e ? "": e + ""
        ...
        q.extend({
            ...
            removeAttr: function(e, t) {
                var n, r, i, a, o = 0;
                if (1 === e.nodeType) for (a = (r = (t || "").split(W)).length; o < a; o++) i = r[o].toLowerCase(),
                n = q.propFix[i] || i,
                q.attr(e, i, ""),
            ...
            attrHooks: {
                type: {
                    set: function(e, t) {
                        if (X.test(e.nodeName) && e.parentNode) q.error("type property can't be changed");
        ...
        P = {
            ...
            set: function(e, t, n) {
                var r;
                return ! 1 === t ? q.removeAttr(e, n) : ((r = q.propFix[n] || n) in e && (e[r] = !0), e.setAttribute(n, n.toLowerCase())),
                n
            }
        },
        K || (B = {
        ...
        z = q.valHooks.button = {
            ...
            set: function(e, t, n) {
                ...
                return r || (r = O.createAttribute(n), e.setAttributeNode(r)),
                r.nodeValue = t + ""
            }
        },
        q.attrHooks.tabindex.set = z.set, q.each(["width", "height"],
        function(e, t) {
        ...
        q.event = {
            add: function(e, n, r, i, a) {
                ...
                if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (o = q._data(e))) {
                    ...
                    s.elem = e), n = ae(n).split(" "), c = 0; c < n.length; c++) d = (u = J.exec(n[c]) || [])[1],
                    f = (u[2] || "").split(".").sort(),
                    g = q.event.special[d] || {},
                    d = (a ? g.delegateType: g.bindType) || d,
                    g = q.event.special[d] || {},
                    p = q.extend({
                        type: d,
                        origType: u[1],
                    ...
                    h),
                    a && (p.quick = re(a), !p.quick && q.expr.match.POS.test(a) && (p.isPositional = !0)),
                    (m = l[d]) || ((m = l[d] = []).delegateCount = 0, g.setup && !1 !== g.setup.call(e, i, f, s) || (e.addEventListener ? e.addEventListener(d, s, !1) : e.attachEvent && e.attachEvent("on" + d, s))),
            ...
            remove: function(e, t, n, r) {
                ...
                if (m && (u = m.events)) {
                    for (t = ae(t || "").split(" "), i = 0; i < t.length; i++) {
                        ...
                        if (d = q.event.special[o] || {},
                        o = (r ? d.delegateType: d.bindType) || o, p = u[o] || [], l = p.length, s = s ? new RegExp("(^|\\.)" + s.split(".").sort().join("\\.(?:.*\\.)?") + "(\\.|$)") : null, n || s || r || d.remove) for (c = 0; c < p.length; c++) h = p[c],
                        n && n.guid !== h.guid || s && !s.test(h.namespace) || (!r || r === h.selector || "**" === r && h.selector) && (p.splice(c--, 1), h.selector && p.delegateCount--, d.remove && d.remove.call(e, h));
                        else p.length = 0;
            ...
            trigger: function(n, r, i, a) {
                if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                    var o, s, l, c, u, d, f, p, h, m, g = n.type || n,
                    v = [];
                    if (g.indexOf("!") >= 0 && (g = g.slice(0, -1), s = !0), g.indexOf(".") >= 0 && (g = (v = g.split(".")).shift(), v.sort()), i && !q.event.customEvent[g] || q.event.global[g]) if (n = "object" == typeof n ? n[q.expando] ? n: new q.Event(g, n) : new q.Event(g), n.type = g, n.isTrigger = !0, n.exclusive = s, n.namespace = v.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, d = g.indexOf(":") < 0 ? "on" + g: "", !a && i || n.preventDefault(), i) {
                        if (n.result = t, n.target || (n.target = i), (r = null != r ? q.makeArray(r) : []).unshift(n), !(f = q.event.special[g] || {}).trigger || !1 !== f.trigger.apply(i, r)) {
                            if (h = [[i, f.bindType || g]], !a && !f.noBubble && !q.isWindow(i)) {
                                for (m = f.delegateType || g, u = null, c = i.parentNode; c; c = c.parentNode) h.push([c, m]),
                                u = c;
                            ...
                            return n.type = g,
                            n.isDefaultPrevented() || f._default && !1 !== f._default.apply(i.ownerDocument, r) || "click" === g && q.nodeName(i, "a") || !q.acceptData(i) || d && i[g] && ("focus" !== g && "blur" !== g || 0 !== n.target.offsetWidth) && !q.isWindow(i) && ((u = i[d]) && (i[d] = null), q.event.triggered = g, i[g](), q.event.triggered = t, u && (i[d] = u)),
                            n.result
                        }
                    } else {
                        o = q.cache;
            ...
            dispatch: function(n) {
                ...
                v = (q.event.special[n.type] || {}).handle,
                y = [];
                if (m[0] = n, n.delegateTarget = this, h && !n.target.disabled && (!n.button || "click" !== n.type)) for (a = n.target; a != this; a = a.parentNode || this) {
                    for (s = {},
                    c = [], r = 0; r < h; r++) f = s[d = (u = p[r]).selector],
                    u.isPositional ? f = (f || (s[d] = q(d))).index(a) >= 0 : f === t && (f = s[d] = u.quick ? ie(a, u.quick) : q(a).is(d)),
                    f && c.push(u);
                    c.length && y.push({
                        elem: a,
                        matches: c
                ...
                (g || !n.namespace && !u.namespace || n.namespace_re && n.namespace_re.test(u.namespace)) && (n.data = u.data, n.handleObj = u, (o = (v || u.handler).apply(l.elem, m)) !== t && (n.result = o, !1 === o && (n.preventDefault(), n.stopPropagation())));
                return n.result
            },
            ...
            mouseHooks: {
                ...
                filter: function(e, n) {
                    ...
                    s = n.fromElement;
                    return null == e.pageX && null != n.clientX && (i = (r = e.target.ownerDocument || O).documentElement, a = r.body, e.pageX = n.clientX + (i && i.scrollLeft || a && a.scrollLeft || 0) - (i && i.clientLeft || a && a.clientLeft || 0), e.pageY = n.clientY + (i && i.scrollTop || a && a.scrollTop || 0) - (i && i.clientTop || a && a.clientTop || 0)),
        ...
        q.removeEvent = O.removeEventListener ?
        function(e, t, n) {
        ...
        function(e, t) {
            q.event.special[e] = q.event.special[t] = {
                ...
                handle: function(e) {
                    ...
                    a = e.handleObj;
                    a.selector;
                    return i && a.origType !== e.type && (i === r || q.contains(r, i)) || (t = e.type, e.type = a.origType, n = a.handler.apply(this, arguments), e.type = t),
                    n
                }
            }
        }),
        q.support.submitBubbles || (q.event.special.submit = {
            setup: function() {
                ...
                q.event.add(this, "click._submit keypress._submit",
                function(e) {
                    var n = e.target,
                    r = q.nodeName(n, "input") || q.nodeName(n, "button") ? n.form: t;
                    r && !r._submit_attached && (q.event.add(r, "submit._submit",
                    function(e) {
        ...
        q.support.changeBubbles || (q.event.special.change = {
            setup: function() {
                if (G.test(this.nodeName)) return "checkbox" !== this.type && "radio" !== this.type || (q.event.add(this, "propertychange._change",
                function(e) {
                ...
                !1;
                q.event.add(this, "beforeactivate._change",
                function(e) {
                    var t = e.target;
                    G.test(t.nodeName) && !t._change_attached && (q.event.add(t, "change._change",
                    function(e) {
        ...
        q.fn.extend({
            ...
            off: function(e, n, r) {
                if (e && e.preventDefault && e.handleObj) {
                    var i = e.handleObj;
                    return q(e.delegateTarget).off(i.namespace ? i.type + "." + i.namespace: i.type, i.selector, i.handler),
                    this
                }
                if ("object" == typeof e) {
        ...
        function(e, t) {
            ...
            q.attrFn && (q.attrFn[t] = !0),
            ee.test(t) && (q.event.fixHooks[t] = q.event.keyHooks),
            te.test(t) && (q.event.fixHooks[t] = q.event.mouseHooks)
        }),
        function() {
            ...
            var f = function(e, t, n, i) {
                ...
                if (T.length > 1 && m.exec(e)) if (2 === T.length && h.relative[T[0]]) l = x(T[0] + T[1], t, i);
                else for (l = h.relative[T[0]] ? [t] : f(T.shift(), t); T.length;) e = T.shift(),
                h.relative[e] && (e += T.shift()),
                l = x(e, l, i);
                else if (!i && T.length > 1 && 9 === t.nodeType && !w && h.match.ID.test(T[0]) && !h.match.ID.test(T[T.length - 1]) && (t = (d = f.find(T.shift(), t, w)).expr ? f.filter(d.expr, d.set)[0] : d.set[0]), t) for (l = (d = i ? {
                    expr: T.pop(),
                    set: v(i)
                }: f.find(T.pop(), 1 !== T.length || "~" !== T[0] && "+" !== T[0] || !t.parentNode ? t: t.parentNode, w)).expr ? f.filter(d.expr, d.set) : d.set, T.length > 0 ? c = v(l) : b = !1; T.length;) g = p = T.pop(),
                h.relative[p] ? g = T.pop() : p = "",
                null == g && (g = t),
                h.relative[p](c, g, w);
                else c = T = [];
                if (c || (c = l), c || f.error(p || e), "[object Array]" === o.call(c)) if (b) if (t && 1 === t.nodeType) for (y = 0; null != c[y]; y++) c[y] && (!0 === c[y] || 1 === c[y].nodeType && f.contains(t, c[y])) && n.push(l[y]);
                else for (y = 0; null != c[y]; y++) c[y] && 1 === c[y].nodeType && n.push(l[y]);
                else n.push.apply(n, c);
                else v(c, n);
                return u && (f(u, a, n, i), f.uniqueSort(n)),
                n
            };
            ...
            f.filter = function(e, n, r, i) {
                for (var a, o, s, l, c, u, d, p, m, g = e,
                v = [], y = n, b = n && n[0] && f.isXML(n[0]); e && n.length;) {
            ...
            h = f.selectors = {
                ...
                relative: {
                    ...
                    "": function(t, r, i) {
                        var o, s = a++,
                        l = n;
                        "string" != typeof r || d.test(r) || (o = r = r.toLowerCase(), l = e),
            ...
            h.leftMatch[g] = new RegExp(/(^(?:.|\r|\n)*?)/.source + h.match[g].source.replace(/\\(\d+)/g,
            function(e, t) {
                return "\\" + (t - 0 + 1)
            }));
            var v = function(e, t) {
            ...
            function() {
                ...
                e.getElementsByClassName && 0 !== e.getElementsByClassName("e").length && (e.lastChild.className = "e", 1 !== e.getElementsByClassName("e").length && (h.order.splice(1, 0, "CLASS"), h.find.CLASS = function(e, t, n) {
            ...
            var x = function(e, t, n) {
                for (var r, i = [], a = "", o = t.nodeType ? [t] : t; r = h.match.PSEUDO.exec(e);) a += r[0],
                e = e.replace(h.match.PSEUDO, "");
                e = h.relative[e] ? e + "*": e;
                for (var s = 0,
                l = o.length; s < l; s++) f(e, o[s], i, n);
                return f.filter(a, i)
            };
            f.attr = q.attr,
            f.selectors.attrMap = {},
            ...
            q.unique = f.uniqueSort,
            q.text = f.getText,
            q.isXMLDoc = f.isXML,
            q.contains = f.contains
        } ();
        var oe = /Until$/,
        ...
        q.fn.extend({
            ...
            has: function(e) {
                ...
                return this.filter(function() {
                    for (var e = 0,
                    n = t.length; e < n; e++) if (q.contains(this, t[e])) return ! 0
                })
            },
            not: function(e) {
            ...
            closest: function(e, t) {
                ...
                if (q.isArray(e)) {
                    for (var o = 1; a && a.ownerDocument && a !== t;) {
                        for (n = 0; n < e.length; n++) q(a).is(e[n]) && i.push({
                            selector: e[n],
                            elem: a,
                            level: o
                        });
                ...
                return i = i.length > 1 ? q.unique(i) : i,
        ...
        function(e, t) {
            q.fn[e] = function(n, r) {
                ...
                a = ue.call(arguments);
                return oe.test(e) || (r = n),
                r && "string" == typeof r && (i = q.filter(r, i)),
                i = this.length > 1 && !fe[e] ? q.unique(i) : i,
        ...
        q.extend({
            ...
            dir: function(e, n, r) {
                for (var i = [], a = e[n]; a && 9 !== a.nodeType && (r === t || 1 !== a.nodeType || !q(a).is(r));) 1 === a.nodeType && i.push(a),
                a = a[n];
                return i
            },
        ...
        Se.th = Se.td,
        q.support.htmlSerialize || (Se._default = [1, "div<div>", "</div>"]),
        q.fn.extend({
            text: function(e) {
            ...
            after: function() {
                ...
                if (arguments.length) {
                    ...
                    return e.push.apply(e, q(arguments[0]).toArray()),
                    e
                }
            },
            remove: function(e, t) {
            ...
            html: function(e) {
                ...
                if ("string" != typeof e || xe.test(e) || !q.support.leadingWhitespace && me.test(e) || Se[(ve.exec(e) || ["", ""])[1].toLowerCase()]) q.isFunction(e) ? this.each(function(t) {
                    ...
                    try {
                        for (var n = 0,
                        r = this.length; n < r; n++) 1 === this[n].nodeType && (q.cleanData(this[n].getElementsByTagName("*")), this[n].innerHTML = e)
                    } catch(t) {
                        this.empty().append(e)
                    }
                }
            ...
            domManip: function(e, n, r) {
                ...
                if (this[0]) {
                    if (s = l && l.parentNode, i = q.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {
                        fragment: s
                    }: q.buildFragment(e, this, c), o = i.fragment, a = 1 === o.childNodes.length ? o = o.firstChild: o.firstChild) {
                        n = n && q.nodeName(a, "tr");
                        for (var u = 0,
                        f = this.length,
                        p = f - 1; u < f; u++) r.call(n ? d(this[u]) : this[u], i.cacheable || f > 1 && u < p ? q.clone(o, !0, !0) : o)
                    }
                    c.length && q.each(c, v)
                }
                return this
        ...
        q.buildFragment = function(e, t, n) {
            ...
            o.createDocumentFragment || (o = O),
            1 === e.length && "string" == typeof s && s.length < 512 && o === O && "<" === s.charAt(0) && !we.test(s) && (q.support.checkClone || !_e.test(s)) && !q.support.unknownElems && Te.test(s) && (i = !0, (a = q.fragments[s]) && 1 !== a && (r = a)),
            r || (r = o.createDocumentFragment(), q.clean(e, o, r, n)),
            i && (q.fragments[s] = a ? r: 1),
            {
                fragment: r,
                cacheable: i
            }
        ...
        function(e, t) {
            q.fn[e] = function(n) {
                ...
                if (a && 11 === a.nodeType && 1 === a.childNodes.length && 1 === i.length) return i[t](this[0]),
                this;
                for (var o = 0,
                s = i.length; o < s; o++) {
        ...
        q.extend({
            ...
            clean: function(e, t, n, r) {
                ...
                for (var a, o, s = [], l = 0; null != (o = e[l]); l++) if ("number" == typeof o && (o += ""), o) {
                    if ("string" == typeof o) if (be.test(o)) {
                        ...
                        } ! q.support.leadingWhitespace && me.test(o) && p.insertBefore(t.createTextNode(me.exec(o)[0]), p.firstChild),
                        o = p.childNodes
                    } else o = t.createTextNode(o);
                    var v;
                    if (!q.support.appendChecked) if (o[0] && "number" == typeof(v = o.length)) for (a = 0; a < v; a++) g(o[a]);
                    else g(o);
            ...
            cleanData: function(e) {
                for (var t, n, r, i = q.cache,
                a = q.event.special,
                o = q.support.deleteExpando,
                s = 0; null != (r = e[s]); s++) if ((!r.nodeName || !q.noData[r.nodeName.toLowerCase()]) && (n = r[q.expando])) {
                    if ((t = i[n]) && t.events) {
                        for (var l in t.events) a[l] ? q.event.remove(r, l) : q.removeEvent(r, l, t.handle);
                        t.handle && (t.handle.elem = null)
                    }
                    o ? delete r[q.expando] : r.removeAttribute && r.removeAttribute(q.expando),
                    delete i[n]
                }
            }
        });
        ...
        q.fn.css = function(e, n) {
            return 2 === arguments.length && n === t ? this: q.access(this, e, n, !0,
            function(e, n, r) {
        ...
        q.extend({
            ...
            css: function(e, n, r) {
                var i, a;
                return n = q.camelCase(n),
                a = q.cssHooks[n],
                "cssFloat" === (n = q.cssProps[n] || n) && (n = "float"),
                a && "get" in a && (i = a.get(e, !0, r)) !== t ? i: je ? je(e, n) : void 0
            },
            swap: function(e, t, n) {
                var r = {};
        ...
        function(e, t) {
            q.cssHooks[t] = {
                get: function(e, n, r) {
                    var i;
                    if (n) return 0 !== e.offsetWidth ? y(e, t, r) : (q.swap(e, Re,
                    function() {
                        i = y(e, t, r)
                    }), i)
                },
        ...
        q.support.opacity || (q.cssHooks.opacity = {
            ...
            set: function(e, t) {
                ...
                n.zoom = 1,
                t >= 1 && "" === q.trim(a.replace(De, "")) && (n.removeAttribute("filter"), r && !r.filter) || (n.filter = De.test(a) ? a.replace(De, i) : a + " " + i)
            }
        }),
        q(function() {
        ...
        O.defaultView && O.defaultView.getComputedStyle && (Ne = function(e, n) {
            ...
            (i = e.ownerDocument.defaultView) ? ((a = i.getComputedStyle(e, null)) && ("" !== (r = a.getPropertyValue(n)) || q.contains(e.ownerDocument.documentElement, e) || (r = q.style(e, n))), r) : t
        }),
        O.documentElement.currentStyle && (Ae = function(e, t) {
            var n, r, i, a = e.currentStyle && e.currentStyle[t],
            o = e.style;
            return null === a && o && (i = o[t]) && (a = i),
            !Fe.test(a) && qe.test(a) && (n = o.left, (r = e.runtimeStyle && e.runtimeStyle.left) && (e.runtimeStyle.left = e.currentStyle.left), o.left = "fontSize" === t ? "1em": a || 0, a = o.pixelLeft + "px", o.left = n, r && (e.runtimeStyle.left = r)),
            "" === a ? "auto": a
        }),
        je = Ne || Ae,
        ...
        try {
            ze = F.href
        } catch(e) { (ze = O.createElement("a")).href = "",
            ze = ze.href
        }
        Pe = nt.exec(ze.toLowerCase()) || [],
        q.fn.extend({
            load: function(e, n, r) {
                ...
                return q.ajax({
                    ...
                    complete: function(e, t, n) {
                        ...
                        e.isResolved() && (e.done(function(e) {
                            n = e
                        }), s.html(a ? q("<div>").append(n.replace(Je, "")).find(a) : n)),
                        r && s.each(r, [n, t, e])
                    }
                }),
                this
        ...
        function(e, n) {
            q[n] = function(e, r, i, a) {
                return q.isFunction(r) && (a = a || i, i = r, r = t),
                q.ajax({
                    type: n,
                    url: e,
                    data: r,
        ...
        q.extend({
            ...
            ajaxSetup: function(e, t) {
                return t ? w(e, q.ajaxSettings) : (t = e, e = q.ajaxSettings),
                w(e, t),
                e
            },
            ajaxSettings: {
            ...
            ajax: function(e, n) {
                function r(e, n, r, o) {
                    if (2 !== w) {
                        ...
                        var c, d, y, b, x, C = n,
                        S = r ? _(f, T, r) : t;
                        if (e >= 200 && e < 300 || 304 === e) if (f.ifModified && ((b = T.getResponseHeader("Last-Modified")) && (q.lastModified[i] = b), (x = T.getResponseHeader("Etag")) && (q.etag[i] = x)), 304 === e) C = "notmodified",
                        c = !0;
                        else try {
                            d = k(f, S),
                            C = "success",
                        ...
                        T.status = e,
                        T.statusText = "" + (n || C),
                        c ? m.resolveWith(p, [d, C, T]) : m.rejectWith(p, [T, C, y]),
                        T.statusCode(v),
                        v = t,
                        u && h.trigger("ajax" + (c ? "Success": "Error"), [T, f, c ? d: y]),
                        g.fireWith(p, [T, C]),
                        u && (h.trigger("ajaxComplete", [T, f]), --q.active || q.event.trigger("ajaxStop"))
                    }
                }
                "object" == typeof e && (n = e, e = t),
                n = n || {};
                var i, a, o, s, l, c, u, d, f = q.ajaxSetup({},
                n),
                p = f.context || f,
                h = p !== f && (p.nodeType || p instanceof q) ? q(p) : q.event,
                m = q.Deferred(),
                ...
                f.ifModified && (i = i || f.url, q.lastModified[i] && T.setRequestHeader("If-Modified-Since", q.lastModified[i]), q.etag[i] && T.setRequestHeader("If-None-Match", q.etag[i])),
            ...
            param: function(e, n) {
                var r = [],
                i = function(e, t) {
                    t = q.isFunction(t) ? t() : t,
                    r[r.length] = encodeURIComponent(e) + "=" + encodeURIComponent(t)
                };
                if (n === t && (n = q.ajaxSettings.traditional), q.isArray(e) || e.jquery && !q.isPlainObject(e)) q.each(e,
                function() {
        ...
        function(t, n, r) {
            ...
            if ("jsonp" === t.dataTypes[0] || !1 !== t.jsonp && (lt.test(t.url) || i && lt.test(t.data))) {
                ...
                c = t.data,
                u = "$1" + o + "$2";
                return ! 1 !== t.jsonp && (l = l.replace(lt, u), t.url === l && (i && (c = c.replace(lt, u)), t.data === c && (l += (/\?/.test(l) ? "&": "?") + t.jsonp + "=" + o))),
                t.url = l,
                t.data = c,
                e[o] = function(e) {
                    a = [e]
        ...
        function(e) {
            if (e.crossDomain) {
                ...
                return {
                    send: function(i, a) { (n = O.createElement("script")).async = "async",
                        e.scriptCharset && (n.charset = e.scriptCharset),
                        n.src = e.url,
                        n.onload = n.onreadystatechange = function(e, i) { (i || !n.readyState || /loaded|complete/.test(n.readyState)) && (n.onload = n.onreadystatechange = null, r && n.parentNode && r.removeChild(n), n = t, i || a(200, "success"))
                        },
        ...
        var ct, ut = !!e.ActiveXObject &&
        function() {
            for (var e in ct) ct[e](0, 1)
        },
        dt = 0;
        q.ajaxSettings.xhr = e.ActiveXObject ?
        function() {
                ...
                return {
                    send: function(i, a) {
                        ...
                        r = function(e, i) {
                            var s, c, u, d, f;
                            try {
                                if (r && (i || 4 === l.readyState)) if (r = t, o && (l.onreadystatechange = q.noop, ut && delete ct[o]), i) 4 !== l.readyState && l.abort();
                                else {
                                    s = l.status,
                                    u = l.getAllResponseHeaders(),
                                    d = {},
                                    (f = l.responseXML) && f.documentElement && (d.xml = f),
                        ...
                        n.async && 4 !== l.readyState ? (o = ++dt, ut && (ct || (ct = {},
                        q(e).unload(ut)), ct[o] = r), l.onreadystatechange = r) : r()
                    },
                    abort: function() {
                        r && r(0, 1)
                    }
        ...
        q.fn.extend({
            show: function(e, t, n) {
                ...
                for (var a = 0,
                o = this.length; a < o; a++)(r = this[a]).style && (i = r.style.display, q._data(r, "olddisplay") || "none" !== i || (i = r.style.display = ""), "" === i && "none" === q.css(r, "display") && q._data(r, "olddisplay", A(r.nodeName)));
            ...
            hide: function(e, t, n) {
                ...
                for (var r, i, a = 0,
                o = this.length; a < o; a++)(r = this[a]).style && ("none" === (i = q.css(r, "display")) || q._data(r, "olddisplay") || q._data(r, "olddisplay", i));
            ...
            animate: function(e, t, n, r) {
                function i() { ! 1 === a.queue && q._mark(this);
                    var t, n, r, i, o, s, l, c, u, d = q.extend({},
                    a),
                    f = 1 === this.nodeType,
                    p = f && q(this).is(":hidden");
                    d.animatedProperties = {};
                    for (r in e) {
                        if (t = q.camelCase(r), r !== t && (e[t] = e[r], delete e[r]), n = e[t], q.isArray(n) ? (d.animatedProperties[t] = n[1], n = e[t] = n[0]) : d.animatedProperties[t] = d.specialEasing && d.specialEasing[t] || d.easing || "swing", "hide" === n && p || "show" === n && !p) return d.complete.call(this); ! f || "height" !== t && "width" !== t || (d.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], "inline" === q.css(this, "display") && "none" === q.css(this, "float") && (q.support.inlineBlockNeedsLayout && "inline" !== A(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"))
                    }
                    null != d.overflow && (this.style.overflow = "hidden");
                    for (r in e) i = new q.fx(this, d, r),
                    n = e[r],
                    vt.test(n) ? (u = q._data(this, "toggle" + r) || ("toggle" === n ? p ? "show": "hide": 0)) ? (q._data(this, "toggle" + r, "show" === u ? "hide": "show"), i[u]()) : i[n]() : (o = yt.exec(n), s = i.cur(), o ? (l = parseFloat(o[2]), "px" !== (c = o[3] || (q.cssNumber[r] ? "": "px")) && (q.style(this, r, (l || 1) + c), s = (l || 1) / i.cur() * s, q.style(this, r, s + c)), o[1] && (l = ("-=" === o[1] ? -1 : 1) * l + s), i.custom(s, l, c)) : i.custom(s, n, ""));
                    return ! 0
                }
                var a = q.speed(t, n, r);
                return q.isEmptyObject(e) ? this.each(a.complete, [!1]) : (e = q.extend({},
                e), !1 === a.queue ? this.each(i) : this.queue(a.queue, i))
            },
            stop: function(e, n, r) {
                ...
                this.each(function() {
                    ...
                    a = q.timers,
                    o = q._data(this);
                    if (r || q._unmark(!0, this), null == e) for (n in o) o[n].stop && n.indexOf(".run") === n.length - 4 && t(this, o, n);
        ...
        q.extend({
            speed: function(e, t, n) {
                ...
                r.complete = function(e) {
                    ...
                    r.queue ? q.dequeue(this, r.queue) : !1 !== e && q._unmark(this)
                },
                r
            },
            easing: {
        ...
        q.fx.prototype = {
            ...
            custom: function(e, n, r) {
                ...
                this.unit = r || this.unit || (q.cssNumber[this.prop] ? "": "px"),
            ...
            show: function() {
                ...
                this.options.orig[this.prop] = e || q.style(this.elem, this.prop),
                this.options.show = !0,
            ...
            step: function(e) {
                ...
                if (e || i >= s.duration + this.startTime) {
                    ...
                    if (a) {
                        if (null == s.overflow || q.support.shrinkWrapBlocks || q.each(["", "X", "Y"],
                        function(e, t) {
                            o.style["overflow" + t] = s.overflow[e]
                        }), s.hide && q(o).hide(), s.hide || s.show) for (t in s.animatedProperties) q.style(o, t, s.orig[t]),
                        q.removeData(o, "fxshow" + t, !0),
                        q.removeData(o, "toggle" + t, !0); (r = s.complete) && (s.complete = !1, r.call(o))
                    }
                    return ! 1
                }
                return s.duration == 1 / 0 ? this.now = i: (n = i - this.startTime, this.state = n / s.duration, this.pos = q.easing[s.animatedProperties[this.prop]](this.state, n, 0, 1, s.duration), this.now = this.start + (this.end - this.start) * this.pos),
                this.update(),
                !0
            }
        },
        ...
        "getBoundingClientRect" in O.documentElement ? q.fn.offset = function(e) {
            ...
            o = i.body,
            s = i.defaultView,
            l = s ? s.getComputedStyle(t, null) : t.currentStyle, c = t.offsetTop, u = t.offsetLeft; (t = t.parentNode) && t !== o && t !== a && (!q.support.fixedPosition || "fixed" !== l.position);) n = s ? s.getComputedStyle(t, null) : t.currentStyle,
            c -= t.scrollTop,
            u -= t.scrollLeft,
            t === r && (c += t.offsetTop, u += t.offsetLeft, !q.support.doesNotAddBorder || q.support.doesAddBorderForTableAndCells && xt.test(t.nodeName) || (c += parseFloat(n.borderTopWidth) || 0, u += parseFloat(n.borderLeftWidth) || 0), r, r = t.offsetParent),
            q.support.subtractsBorderForOverflowNotVisible && "visible" !== n.overflow && (c += parseFloat(n.borderTopWidth) || 0, u += parseFloat(n.borderLeftWidth) || 0),
            l = n;
            return "relative" !== l.position && "static" !== l.position || (c += o.offsetTop, u += o.offsetLeft),
            q.support.fixedPosition && "fixed" === l.position && (c += Math.max(a.scrollTop, o.scrollTop), u += Math.max(a.scrollLeft, o.scrollLeft)),
            {
                top: c,
                left: u
            }
        ...
        q.offset = {
            ...
            setOffset: function(e, t, n) {
                ...
                c = q.css(e, "left"),
                u = {},
                d = {}; ("absolute" === r || "fixed" === r) && q.inArray("auto", [l, c]) > -1 ? (i = (d = o.position()).top, a = d.left) : (i = parseFloat(l) || 0, a = parseFloat(c) || 0),
        ...
        function(e, n) {
            ...
            q.fn[r] = function(n) {
                var i, a;
                return n === t ? (i = this[0]) ? (a = D(i)) ? "pageXOffset" in a ? a[e ? "pageYOffset": "pageXOffset"] : q.support.boxModel && a.document.documentElement[r] || a.document.body[r] : i[r] : null: this.each(function() { (a = D(this)) ? a.scrollTo(e ? q(a).scrollLeft() : n, e ? n: q(a).scrollTop()) : this[r] = n
                })
            }
        }),
        q.each(["Height", "Width"],
...
define("newweb/common/jquery.selectRange", [],
function(e, t) {
    var n = e("./jquery-1.7");
...
define("newweb/common/log", [],
function(e, t) {
    var n = e("./jquery-1.7");
    t.clog = function(e, t, n) { (new Image).src = n ? "/ctlog?pos=" + t + "&action=" + e + "&check=" + n: "/ctlog?pos=" + t + "&action=" + e
    },
    t.init = function() {
        n(".clog-js").live("click",
        function() {
            var e = n(this),
            r = e.data("clog"),
            i = e.data("pos"),
...
define("newweb/common/manTranslate", [],
function(e, t) {
    function n() {
...
function(e, t) {
    ...
    f = function(e) {
        ...
        r = n + 8,
        i = 16 * ((r - r % 64) / 64 + 1), a = Array(i - 1), o = 0, s = 0; s < n;) o = s % 4 * 8,
...
define("newweb/common/select", [],
function(e, t) {
    var n = e("./jquery-1.7");
    n.fn.select = function(e) {
        var t = this,
        r = (e = e || {}).changedCallback ||
        function() {};
        t.click(function(e) {
            var t = n(this);
            t.removeClass("error-format"),
            t.find(".error-message").remove(),
            n(this).find(".select").is(":visible") ? (n(this).find(".select").slideUp("fast"), n(".item-select").removeClass("top")) : (n(".item-select").removeClass("top"), t.addClass("top"), n(".item-select .select").slideUp(), 0 != t.find(".select").children().length && t.find(".select").slideDown("fast")),
            e.stopPropagation(),
            e.cancelBubble = !0
        }),
        ...
        t.find(".select").click(function(e) {
            var i = n(e.target),
            a = i.text();
            if (i.hasClass("group")) return e.stopPropagation(),
...
define("newweb/common/smartResult", ["./TranslateState", "./log"],
function(e, t) {
    var n = e("./jquery-1.7"),
    ...
    n(".dict__relative").delegate("a", "click",
    function() {
    ...
    t.render = function(e, t) {
        ...
        if (i.html(""), n(".dict__word--phonetic").html(""), t && a.length > 0) {
            ...
            for (var l = 0; l < a.length; l++) if ("" != a[l]) {
                o = !0;
                var c = s.getLink(1, a[l]),
                u = "";
                "javascript:;" == c ? (u = "no-link", i.append('<span class="' + u + '">' + a[l].replace(/\r\n/, "") + "</span>")) : i.append('<a target="_blank" href="' + c + '">' + a[l].replace(/\r\n/, "") + "</a>")
            }
            o ? r.show() : r.hide();
            var d = "http://dict.youdao.com/search?q=" + e + "&keyfrom=new-fanyi.smartResult";
            n(".dict__more").attr("href", d),
            n(".dict__more").show()
        } else r.hide()
    },
    t.hide = function() {
...
define("newweb/common/star", ["./TranslateState"],
function(e, t) {
    function n(e) {
    ...
    a("#targetStarTip .star-con span").on("click",
    function() {
    ...
    t.reset = function() {
        l = !1,
        a("#targetStarTip .star-con span").removeClass("add-star")
    }
}),
define("newweb/common/textAuto", [],
function(e, t) {
    var n = e("./jquery-1.7");
    t.resizeTextarea = function(e) {
        var t = e.value.length,
        r = e.offsetWidth;
        if (n(e).data("lastHeight", e.style.height), t !== e.valLength || r !== e.boxWidth) { (t < e.valLength || r !== e.boxWidth) && (e.style.height = "0");
...
define("newweb/common/translate", ["./utils", "./voice", "./TranslateState", "./log", "./service", "./md5", "./jquery-1.7", "./smartResult", "./requestMoreTrans", "./constData"],
function(e, t) {
    function n() {
    ...
    function r(e) {
        for (var t = e.translateResult,
        n = [], r = 0, i = q(L.state.type), a = 0; a < t.length; a++) {
            var o = t[a],
            s = [];
            r += o.length;
            for (var l = 0; l < o.length; l++) {
                var c = o[l].tgt,
                u = o[l].src;
                1 == o.length && "" === c && "" === u && (c = '<br class="fanyi-br-empty-format">'),
                c = '<span data-section="' + a + '" data-sentence="' + l + '">' + c + "</span>",
                l != o.length - 1 && (c += i),
                s.push(c)
            }
        ...
        var d = n.join("");
        T.html(d),
        L.state.originalTgt = T.text(),
        L.state.smallFont ? T.addClass("input__target__text--small") : T.removeClass("input__target__text--small")
    }
    function i(e) {
        var t = function() {
            function e() {
    ...
    function o(e) {
        function t(e) {
            ...
            return n = n.split("»"),
            "from" === e ? t ? "auto": a(n[0]) : "to" === e ? t ? "auto": a(n[1]) : void 0
        }
        var n = f.trim(w.val());
        n = n.replace(/\n/g, "").replace(/\r\n/g, "");
        ...
        r.className = "transWebsite",
        r.setAttribute("target", "_blank"),
        r.appendChild(document.createTextNode(n)),
        T.html(r),
        "TURN_NEW_PAGE" === e && (window.location.href = i)
    }
    function s(e) {
    ...
    function l(e) {
        ...
        e && 0 == e.errorCode ? (L.state = f.extend(L.state, e), s(L.state.type), r(e), e.smartResult && e.translateResult.length > 0 && e.translateResult[0].length > 0 ? (b.clog("RESULT_DICT_SHOW"), y.render(e.translateResult[0][0].src, e.smartResult)) : y.hide(), h.showVoice(L.state.type)) : e && e.errorCode > 0 ? (y.hide(), f("#langSelect").selectValue("AUTO"), i(O.errorMsg[e.errorCode])) : T.html(""),
        M()
    }
    function c(e, t) {
        if (L.state.originalText = e.i, "first" == e.action) return l(global.translatedJson),
        void t();
        m && (m.abort(), m = null),
        m = f.ajax({
            type: "POST",
    ...
    q = function(e) {
        if ("string" == typeof e) {
            ...
            if (2 === t.length) {
                var n = t[1];
                if ("en" === n || "fr" === n || "es" === n || "pt" === n || "vi" === n || "de" === n || "ru" === n || "id" === n || "ar" === n || "it" === n || "nl" === n || "th" == n) return " "
            }
        }
        return ""
    },
    ...
    function() {
        function e() {
            for (var e = w.val().split(/[\r\n]/g), t = L.state.translateResult, n = 0, r = t.length; n < r; n++) {
                var i = t[n].length - 1,
                a = e[n].lastIndexOf(t[n][i].src),
                o = e[n].substring(a).replace(/\r\n/g, "");
                t[n][i].src = o
            }
            return t
        }
        ...
        function i() {
            j && (clearTimeout(j), j = "", f(".fanyi__update__tip").stop(!0, !0)),
        ...
        T.delegate("span", "mouseover",
        function() {
            if (!g) {
                var e = f(this),
                n = e.attr("data-section"),
                i = e.attr("data-sentence"),
                a = L.state.translateResult[n][i].src,
                o = t(n, i),
                ...
                e.addClass("hover"),
                b.clog("MATCHING_HOVER&type=" + L.state.type)
            }
        }),
        T.delegate("span", "click",
        function() {
            if (!g) {
                var e = f(this),
                n = e.attr("data-section"),
                ...
                a = L.state.translateResult[n][r].tgt,
                o = t(n, r),
                ...
                b.clog("MUL_RESULT_CLICK&type=" + L.state.type);
        ...
        f("#fanyiSuggest").delegate("li", "click",
        function() {
            ...
            n(),
            e.addClass("updated");
            var a = L.state.updateEle,
            o = a.attr("data-section"),
            s = a.attr("data-sentence"),
            l = L.state.translateResult[o][s].src,
            c = L.state.translateResult[o][s].tgt,
            u = L.state.getDetectedFromTo()[0],
            d = L.state.getDetectedFromTo()[1];
            v.recordMoreResultLog_choose({
                i: l,
                tgt: c,
                systemName: r,
                pos: i,
        ...
        f(".suggest__title--close").on("click",
        function() {
            d()
        }),
        T.delegate("span", "mouseout",
        function() {
            g || (f("#transTarget span.hover").removeClass("hover"), D || w.selectRange({
                start: 0,
                end: 0
            }), i())
        }),
        f(".input__target").on("mousedown",
        function(e) {
            a(),
            g = !0,
            f("#transTarget span.hover").removeClass("hover"),
        ...
        f(".input__target").on("mouseup",
        function(e) {
            null == p.getSelectionText() && (g = !1),
            o()
        }),
        f(".suggest__update__btn").on("click",
        function() {
            b.clog("RESULT_SINGEL_MODIFY_CLICK"),
    ...
    t.translate = function(e, t) {
        ...
        } else _.removeClass("fonts__overed"),
...
define("newweb/common/updateResult", ["./service", "./utils", "./md5", "./jquery-1.7", "./TranslateState", "./log"],
function(e, t) {
    var n = e("./jquery-1.7"),
    r = n("#updateResult"),
    i = n("#transTarget"),
    ...
    t.init = function() {
        r.click(function(e, t) {
            ...
            i.hasClass("input__target__text--small") ? a.addClass("input__target__text--small") : a.removeClass("input__target__text--small"),
            a.css({
                height: i.height(),
                width: i.width()
            }),
...
function(e) {
    ...
    return {
        ...
        storage: function(e, t) {
            ...
            } (e, t) : document.documentElement.addBehavior ?
            function(e, t) {
                var n = document.documentElement;
                return n.addBehavior("#default#userData"),
                void 0 === t ? (n.load("fanyiweb2"), n.getAttribute(e)) : void 0 !== e && void 0 !== t ? (n.setAttribute(e, t), n.save("fanyiweb2"), t) : void 0
            } (e, t) : void 0
        },
        blink: function(e, t) {
            var n = "",
            ...
            var l = {};
            l[i] = a,
            n = setInterval(function() {++r > t.count ? clearInterval(n) : e.animate(s, 20, "linear",
                function() {
        ...
        throttle: function(e, t, n, r) {
            ...
            function a() {
                ...
                u = Date.now() - l,
                d = arguments;
                s || (r && !o && a(), i(), void 0 === r && u > e ? a() : !0 !== t && (o = setTimeout(r ?
                function() {
                    o = void 0
                }: a, void 0 === r ? e - u: e)))
            }
...
define("newweb/common/voice", ["./TranslateState", "./log"],
function(e, t) {
    var n = e("./jquery-1.7"),
    r = e("./TranslateState"),
    i = e("./log"),
...
define("newweb/index", ["./common/log", "./common/account", "./common/hotLink", "./common/download", "./common/utils", "./common/voice", "./common/TranslateState", "./operations", "./langSelect", "./common/star", "./common/select", "./common/manTranslate", "./input", "./common/textAuto", "./common/translate", "./common/service", "./common/md5", "./common/jquery-1.7", "./common/smartResult", "./common/requestMoreTrans", "./common/constData", "./common/docTrans", "./common/form", "./common/copy", "./common/ZeroClipboard", "./common/updateResult", "./common/advertisement"],
function(e) {
    e("./common/jquery-1.7")(function() {
        ...
        e("./common/advertisement")
    })
}),
define("newweb/input", ["./common/textAuto", "./common/translate", "./common/utils", "./common/voice", "./common/TranslateState", "./common/log", "./common/service", "./common/md5", "./common/jquery-1.7", "./common/smartResult", "./common/requestMoreTrans", "./common/constData", "./common/star", "./common/docTrans", "./common/form", "./common/account", "./langSelect", "./common/select"],
function(e, t) {
    function n() {
        var e = u.val(),
        t = 0,
    ...
    function s(e) {
        ...
        d = n();
        u[0].scrollTop = 0,
        d[0] ? (t.addClass("input__small__font"), t.css({
            "font-size": "14px",
            "line-height": "18px"
        ...
        d[1] ? c.hide() : c.show(),
        "" != l.trim(s) ? (a(), f.resizeTextarea(u[0]), l("#transTarget").removeClass("input__target__text--updated"), p.translate(e,
        function() {
            r()
        }), y.reset(), b.hideDocTrans()) : (o(), m.showVoice("AUTO"), l("#transTarget").html(""), l("#transTarget").css("height", "auto"), u.css("height", "auto"), g.hide(), l("#langSelect").selectValue("AUTO"), l(".fanyi-error-message").html(""), l("#docUploadBg").is(":visible") || b.showDocTrans()),
        i()
    }
    ...
    l("#transMachine").on("click",
    function(e, t, n) {
        if (b.isDocMode) return v.clog("DOC_TRANS_CLICK", ""),
...
define("newweb/langSelect", ["./common/TranslateState", "./common/star", "./common/select", "./common/log"],
function(e, t) {
    ...
    t.init = function() {
        n("#langSelect").select({
            changedCallback: function() {
                ...
                "ar" == e.split("2", 1) ? (n(".input__original .fanyi__input__bg").addClass("fanyi__input__bg__ar"), n(".input__original_delete").addClass("input__original_delete_ar")) : (n(".input__original .fanyi__input__bg").removeClass("fanyi__input__bg__ar"), n(".input__original_delete").removeClass("input__original_delete_ar")),
                n("#language").val(e),
                "AUTO" == e ? r.state.isSelectLan = !1 : (r.state.isSelectLan = !0, n("#langSelect").removeClass("empty-lang")),
                r.state.type = e,
                "" != n("#inputOriginal").val() && n("#transMachine").trigger("click", [!0, "lan-select"]),
                i.reset(),
                a.clog("LAN_SWITCH_CLICK", "")
            }
        })
    },
...
define("newweb/operations", ["./langSelect", "./common/TranslateState", "./common/star", "./common/select", "./common/log", "./common/utils"],
function(e, t) {
    function n() {
        "ON" === u.cookie("YOUDAO_FANYI_SELECTOR") ? (l(".fanyi__operations--underline").addClass("fanyi__operations--underline--checked"), YoudaoSelector.Config.select = "on") : (l(".fanyi__operations--underline").removeClass("fanyi__operations--underline--checked"), YoudaoSelector.Config.select = "off"),
        l(".fanyi__operations--underline").on("click",
        function() {
            var e = l(this);
    ...
    function s() {
        ...
        "1" !== u.storage("rengongEntrance") ? (u.storage("rengongEntrance", "1"), l(".rengong__guide").show()) : (l(".rengong__guide").addClass("rengong__guide--nobtn"), l(".rengong__guide").hide(), e()),
        l(".i-know").on("click",
        function() {
            l(".rengong__guide").hide(),
